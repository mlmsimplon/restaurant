...
<?php require "navBar.php"; ?>
    ...
    <div id="blocktext">
        <p>
            ...
            Sed tamen haec cum itaartuum inminuto rogati ad nuptias ubi aurum dext tutius <br>
            haec cum ita tutius observentur, quidam vigore <br>
            haec cum ita tutius observentur, quid
            Epigonus quidem amictu n haec cum ita tutius observentur <br> quidam vigore manibutenus <br>
